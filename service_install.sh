...
readonly SERVICE_NAME=coffee-pump
...
# Default-Stop:      0 1 6
# Short-Description: Coffee Pump daemon
# Description:       CoffeePump-enabled user script
#                    (https://cloud4rpi.io/)
### END INIT INFO
...
uninstall() {
  printf "Do you really want to uninstall this Coffee Pump service? That cannot be undone. [yes|no] "
  read -r REPLY
  if [ "\$REPLY" = "yes" ]; then
    stop
